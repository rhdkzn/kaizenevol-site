...
/* Multi-word product names, matched as WHOLE PHRASES and removed before the per-word
   scan. Added 2026-09-04 for "The Kaizen Acquisition System", renamed "The Kaizen Loop" 2026-09-05. The tempting fix was to
...
const PHRASES = [/The Kaizen Loop/g, /Kaizen Loop/g]
